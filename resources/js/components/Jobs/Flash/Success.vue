<template>
    <transition name="fade">
        <div class="alert-flash-success bg-white shadow-lg border border-gray-300 px-4 py-4 rounded-lg relative flex items-start justify-between" role="alert" v-show="show">
