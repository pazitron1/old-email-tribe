...
@section('content')
    <section class="pt-20 md:pt-32">
        ...
        <h1 class="text-gray-900 text-lg md:text-3xl text-center tracking-wide leading-10 font-bold">Discover the best <span class="text-indigo-600">{{strtolower($category->name)}}</span> jobs</h1>
    </section>
    ...
    <section class="pt-4 md:pt-10">
        ...
        <div class="block md:flex space-x-4">
            ...
            <all-jobs category="{{$category->slug}}"></all-jobs>
